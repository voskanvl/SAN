...
export const createFakeData = (option_data_san: { [key: string]: Option }) => ({
    optionInArray: Object.values(option_data_san) as Option[],
    chairbacks: Object.values(
        (Object.values(option_data_san) as Option[])[1].product_option_value,
    ).flat(),
    chairbacksColors: Object.values(
        Object.values((Object.values(option_data_san) as Option[])[1].product_option_value).flat(),
    ),
});
